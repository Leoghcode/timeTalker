...
<div class="dropdown" style="position:relative;left:30px"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Chart <b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a onclick="bar()">Daily Time</a></li>
					<li><a onclick="liquid()">Task Percentage</a></li>
...
<script src="./myStyle/liquidFillGauge.js" language="JavaScript"></script>
<style>
        .liquidFillGaugeText { font-family: Helvetica; font-weight: bold; }
</style>

<div style="width:80%; height:80% ;position:relative; left:120px">
...
function liquid(){
	window.location.href="./liquid.jsp"
